...
const FALLBACK_SOURCES: Array<{
  ...
  {
    title: "Gouvernement — Compte-rendu du Conseil des Ministres & Dossiers d'actualité",
    content: "Retrouvez l'action complète du Gouvernement : communiqués officiels, grands arbitrages du Conseil des ministres, projets de lois prioritaires, décrets et dossiers de presse ministériels.",
    source_url: "https://www.info.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "communique",
    source_site: "info.gouv.fr",
    keywords: ["gouvernement", "info.gouv", "conseil des ministres", "premier ministre", "décret", "decret", "communique", "communiqué"],
  },
  {
    title: "Service-Public.fr — Le guide officiel des droits, démarches et réformes",
    content: "Le portail officiel de l'administration française informe les citoyens des règles en vigueur : démarches administratives, actualités juridiques, aides publiques, droits des salariés et évolutions législatives appliquées.",
    source_url: "https://www.service-public.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "service-public.gouv.fr",
    keywords: ["service public", "service-public", "démarche", "demarche", "droit", "droits", "administration", "impots", "aide", "pension"],
  },
  {
    title: "Ministère des Armées — Souveraineté militaire et Loi de Programmation Militaire",
    content: "L'actualité de la Défense nationale : mise en œuvre de la LPM 2024-2030 (413 milliards d'euros), soutien aux forces armées, dissuasion nucléaire, partenariats stratégiques européens et opérations extérieures.",
    source_url: "https://www.defense.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "defense.gouv.fr",
    keywords: ["defense", "défense", "armees", "armées", "militaire", "lpm", "soldats", "dissuasion", "marine", "aviation"],
  },
  {
    title: "Ministère de l'Économie — Souveraineté industrielle et soutien au pouvoir d'achat",
    content: "Toute la politique économique et financière de la France : réindustrialisation avec France 2030, maîtrise de la dette publique, lutte contre l'inflation, soutien aux entreprises et attractivité des investissements.",
    source_url: "https://www.economie.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "economie.gouv.fr",
    keywords: ["economie", "économie", "finances", "inflation", "pouvoir d'achat", "pib", "dette", "entreprises", "impot"],
  },
  {
    title: "Ministère de l'Intérieur — Sécurité nationale et gestion des flux migratoires",
    content: "L'action du ministère de l'Intérieur : sécurité quotidienne des Français, renforcement des forces de police et de gendarmerie, application de la loi immigration et protection civile.",
    source_url: "https://www.interieur.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "interieur.gouv.fr",
    keywords: ["interieur", "intérieur", "securite", "sécurité", "police", "gendarmerie", "immigration", "prefecture", "préfet"],
  },
  {
    title: "Ministère de l'Europe et des Affaires Étrangères — Action diplomatique de la France",
    content: "Positions internationales de la France : diplomatie européenne, coopération multilatérale, paix et sécurité dans le monde, gestion des crises internationales et représentation diplomatique.",
    source_url: "https://www.diplomatie.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "diplomatie.gouv.fr",
    keywords: ["diplomatie", "affaires etrangeres", "affaires étrangères", "international", "traite", "traité", "ambassade", "onu", "ue"],
  },
  {
    title: "Ministère de l'Éducation Nationale — Réforme de l'école et savoirs fondamentaux",
    content: "Les orientations de l'Éducation nationale : renforcement des savoirs fondamentaux (français, mathématiques), organisation des groupes de niveau au collège, revalorisation du métier d'enseignant et sécurité dans les établissements.",
    source_url: "https://www.education.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "education.gouv.fr",
    keywords: ["education", "éducation", "ecole", "école", "college", "collège", "lycee", "lycée", "enseignants", "professeurs"],
  },
  {
    title: "Ministère de la Santé — Offre de soins et lutte contre les déserts médicaux",
    content: "La politique de santé publique : modernisation de l'hôpital, lutte contre les déserts médicaux, suppression du numerus clausus, déploiement des maisons de santé et prévention.",
    source_url: "https://sante.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "sante.gouv.fr",
    keywords: ["sante", "santé", "hopital", "hôpital", "medecins", "médecins", "deserts medicaux", "déserts médicaux", "urgences"],
  },
  {
    title: "Ministère de la Transition Écologique — Planification et énergies décarbonées",
    content: "Mise en œuvre de la planification écologique : transition vers les énergies renouvelables et le nucléaire, décarbonation de l'industrie et du transport, protection de la biodiversité.",
    source_url: "https://www.ecologie.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "ecologie.gouv.fr",
    keywords: ["ecologie", "écologie", "transition", "environnement", "biodiversite", "biodiversité", "climat", "renouvelables"],
  },
  {
    title: "Ministère de la Justice — Moyens de la justice et efficacité pénale",
    content: "L'action du ministère de la Justice : loi de programmation de la justice, recrutement de magistrats et greffiers, création de places de prison et réduction des délais de jugement.",
    source_url: "https://www.justice.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "justice.gouv.fr",
    keywords: ["justice", "magistrats", "tribunal", "tribunaux", "peine", "prison", "code penal", "code pénal", "greffiers"],
  },
  {
    title: "Ministère de l'Agriculture — Souveraineté alimentaire et loi Egalim",
    content: "Accompagnement du monde agricole : garantie du revenu paysan via la loi Egalim, simplification des normes administratives, aides à l'installation des jeunes agriculteurs et souveraineté alimentaire.",
    source_url: "https://www.agriculture.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "agriculture.gouv.fr",
    keywords: ["agriculture", "agriculteurs", "fermiers", "egalim", "alimentation", "elevage", "élevage", "recolte", "récolte"],
  },
  {
    title: "Ministère du Travail — Objectif Plein Emploi et apprentissage",
    content: "La politique du travail et de l'emploi : déploiement de France Travail, réforme de l'assurance chômage, développement de l'apprentissage et insertion professionnelle des jeunes.",
    source_url: "https://www.travail-emploi.gouv.fr/",
    source_date: "2026-09-12",
    source_type: "actualite",
    source_site: "travail-emploi.gouv.fr",
    keywords: ["travail", "emploi", "chomage", "chômage", "france travail", "apprentissage", "salaries", "salariés", "retraites"],
  },
];
